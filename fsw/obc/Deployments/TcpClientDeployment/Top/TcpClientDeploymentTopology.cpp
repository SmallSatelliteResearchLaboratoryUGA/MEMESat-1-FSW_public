// ======================================================================
// \title  TcpClientDeploymentTopology.cpp
...
Svc::Health::PingEntry pingEntries[] = {
    {PingEntries::TcpClientDeployment_blockDrv::WARN, PingEntries::TcpClientDeployment_blockDrv::FATAL, "blockDrv"},
    {PingEntries::TcpClientDeployment_tlmSend::WARN, PingEntries::TcpClientDeployment_tlmSend::FATAL, "chanTlm"},
    {PingEntries::TcpClientDeployment_cmdDisp::WARN, PingEntries::TcpClientDeployment_cmdDisp::FATAL, "cmdDisp"},
    {PingEntries::TcpClientDeployment_cmdSeq::WARN, PingEntries::TcpClientDeployment_cmdSeq::FATAL, "cmdSeq"},
    {PingEntries::TcpClientDeployment_eventLogger::WARN, PingEntries::TcpClientDeployment_eventLogger::FATAL, "eventLogger"},
    {PingEntries::TcpClientDeployment_fileDownlink::WARN, PingEntries::TcpClientDeployment_fileDownlink::FATAL, "fileDownlink"},
    {PingEntries::TcpClientDeployment_fileManager::WARN, PingEntries::TcpClientDeployment_fileManager::FATAL, "fileManager"},
    {PingEntries::TcpClientDeployment_fileUplink::WARN, PingEntries::TcpClientDeployment_fileUplink::FATAL, "fileUplink"},
    {PingEntries::TcpClientDeployment_prmDb::WARN, PingEntries::TcpClientDeployment_prmDb::FATAL, "prmDb"},
    {PingEntries::TcpClientDeployment_rateGroup1::WARN, PingEntries::TcpClientDeployment_rateGroup1::FATAL, "rateGroup1"},
    {PingEntries::TcpClientDeployment_rateGroup2::WARN, PingEntries::TcpClientDeployment_rateGroup2::FATAL, "rateGroup2"},
    {PingEntries::TcpClientDeployment_rateGroup3::WARN, PingEntries::TcpClientDeployment_rateGroup3::FATAL, "rateGroup3"},
};
...
void configureTopology() {
    ...
    // Note: Uncomment when using Svc:TlmPacketizer
    // tlmSend.setPacketList(TcpClientDeploymentPacketsPkts, TcpClientDeploymentPacketsIgnore, 1);
...
// Public functions for use in main program are namespaced with deployment name TcpClientDeployment
...
void startSimulatedCycle(Fw::TimeInterval interval) {
    ...
    // Main loop
    while (cycling) {
        TcpClientDeployment::blockDrv.callIsr();
