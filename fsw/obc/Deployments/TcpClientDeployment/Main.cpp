...
static void signalHandler(int signum) {
    TcpClientDeployment::stopSimulatedCycle();
}
...
int main(int argc, char* argv[]) {
    ...
    TcpClientDeployment::TopologyState inputs;
    ...
    TcpClientDeployment::setupTopology(inputs);
    TcpClientDeployment::startSimulatedCycle(Fw::TimeInterval(1,0));  // Program loop cycling rate groups at 1Hz
    TcpClientDeployment::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
