// ======================================================================
// \title  BBSMessageStorage.hpp
// \author heron
// \brief  hpp file for BBSMessageStorage component implementation class
// ======================================================================
...
#include "Components/MessageStorage/MessageStorageComponentAc.hpp"
...
namespace MessageModule {
  ...
  { 
    ...
    class StackBuffer : public Fw:: SerializeBufferBase 
    {
      private: 
        ...
        const static U32 CAPACITY = MessageModule::Message::SERIALIZED_SIZE;
      ...
      public: 
        ...
        /** 
         * @brief Get the Buff Left object
         * TODO: This is a hack to get the buffer left. 
         */
        ...
        template <typename T> 
        void safeSerialize( 
          const T &serializable /*!< The serializable to be serialized */
        )
        { 
          this->resetSer(); 
          Fw::SerializeStatus serialize_status = this->serialize(serializable);
        ...
        void safeDeserialize( 
          ...
          const NATIVE_UINT_TYPE read_size, /*< The number of bytes that are valid in this buffer and can be deserialized */
        ...
        )
        {
          ...
          { 
            // If the deserialized type did not use all of the available data in this buffer, this is an error.
            trigger_deserialize_length_failure(this->getBuffLeft()); // The number of bytes that were not used
          }
        }
        private: 
          U8 m_buff[CAPACITY];
  ...
  class MessageStorage :  
    public MessageStorageComponentBase
  {
    private: 
      // ----------------------------------------------------------------------
      ...
      //! directory.
      //!
      //! Stores only up to the last N of such indices where N = BBSMESSAGESTORAGE_STORED_INDEX_HISTORY_SIZE.
      ...
      //! BBSMessageStorage_MessageWriteError is triggered.
      //!
      bool storeMessage(
      ...
      //! In the latter case, the passed BBSMessage object is not modified.
      //!
      //! If the message was not successfully loaded, an event of type
      //! BBSMessageStorage_MessageReadError is triggered. The given BBSMessage object may
      //! have been modfiied and is not guaranteed to be in a valid state.
      bool loadMessage(
          const U32 index,       /*!< The index at which to load the message */
          Fw::Serializable &data /*!< The BBS message object which will be loaded from file. The variable behind the
                                      the given reference will be overwritten with the loaded BBSMessage (if loading
                                      was successful) */
      );
      ...
      //! existing files.
      //!
      //! Returns true if a stored BBS message was found and the nextIndexCounter was thus set
      ...
      //! Checks whether the configured storage directory (BBSMESSAGESTORAGE_MSGFILE_DIRECTORY) exists and creates it
    ...
    public: 
      ...
      //! Construct object BBSMessageStorage
      //!
      MessageStorage(
        const char *const compName
      );

      //! Initialize object BBSMessageStorage
      //!
      void init( 
        const NATIVE_INT_TYPE instance = 0 /*!< The instance number*/
      ); 

      //! Destroy object BBSMessageStorage
      //!
      ~MessageStorage(); 
    ...
    private: 
      ...
      //!
      //! Is thread-safe: multiple threads can call this function at the same time.
      MessageModule::MessageStorageStatus storeMessage_handler( 
        const NATIVE_INT_TYPE portNum, /*!< The port number */
        const MessageModule::Message &data /*! The content of the message */
      ) override;

      //! Handler implementation for loadMessage
      //!
      //! Does not make any assumptions about the members of BBSMessage. I.e., only handles it as a Serializeable type.
      MessageModule::MessageValid loadMessageFromIndex_handler(
        const NATIVE_INT_TYPE portNum, /*!< The port number */
        const U32 index, /*!< The index at which to load the message */
        MessageModule::Message &data /*! The BBS message object which will be loaded from file. The variable behind the
                                        the given reference will be overwritten with the loaded BBSMessage (if loading
                                        was successful) */
      ) override;
    ...
    U8 loadMessageLastN_handler( 
      ...
      MessageModule::Message_Batch &lastMessages /*!< The BBS message object which will be loaded from file. The variable behind the
                                                    the given reference will be overwritten with the loaded BBSMessage (if loading
                                                    was successful) */
    ) override;
