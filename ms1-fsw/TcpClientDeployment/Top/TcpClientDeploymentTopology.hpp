// ======================================================================
// \title  TcpClientDeploymentTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef TCPCLIENTDEPLOYMENT_TCPCLIENTDEPLOYMENTTOPOLOGY_HPP
...
<<<<<<<< HEAD:obc/ms1/TcpClientDeployment/Top/TcpClientDeploymentTopology.hpp
 * TcpClientDeployment::TopologyState see: TcpClientDeploymentTopologyDefs.hpp.
========
 * TcpClientUartSandboxDepl::TopologyState see: TcpClientUartSandboxDeplTopologyDefs.hpp.
>>>>>>>> main:obc/ms1/TcpClientUartSandboxDepl/Top/TcpClientUartSandboxDeplTopology.hpp
 *
 ...
 *
<<<<<<<< HEAD:obc/ms1/TcpClientDeployment/Top/TcpClientDeploymentTopology.hpp
 * For an explanation of the required type TcpClientDeployment::TopologyState see: TcpClientDeploymentTopologyDefs.hpp.
========
 * For an explanation of the required type TcpClientUartSandboxDepl::TopologyState see: TcpClientUartSandboxDeplTopologyDefs.hpp.
>>>>>>>> main:obc/ms1/TcpClientUartSandboxDepl/Top/TcpClientUartSandboxDeplTopology.hpp
 *
